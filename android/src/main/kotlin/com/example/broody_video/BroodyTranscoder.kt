...
class BroodyTranscoder(private val context: Context) {
    ...
    fun transcodeClip(
        ...
        val targetAudioFormat = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            MediaFormat.createAudioFormat(
                ...
                setInteger(MediaFormat.KEY_PROFILE, MediaCodecInfo.CodecProfileLevel.AACObjectMain)
        ...
        _mediaTransformer
            .transform(UUID.randomUUID().toString(), trackTransforms, listener, options.granularity)
    }
    ...
    private fun buildBlankAudioMediaTransform(
        ...
        val trackTransformBuilder = TrackTransform.Builder(
            BlankAudioMediaSource(durationUs, targetFormat),
            trackIndex,
            mediaTarget
        )
        trackTransformBuilder
            ...
            .setDecoder(PassthroughDecoder(targetFormat.getInteger(MediaFormat.KEY_MAX_INPUT_SIZE)))
            .setEncoder(encoder)
